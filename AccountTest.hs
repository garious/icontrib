...
addUserTests db = do
    ...
    assertEqErrorT "login empty"  (A.loginToCookie db "hello" "world")   (Left "DoesntExist")     -- User doesn't exist
    ...
    assertEqErrorT "added user"   (A.addUser db "hello" "again")         (Left "AlreadyExists") -- User 'hello' already exists
